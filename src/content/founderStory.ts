...
export const founderStory = {
  ...
  whyRedemption: [
    ...
    "A cleanout rarely happens in an easy season. It comes with a loss, a move, a sale, or a property that has gotten away from someone. That is why the promise is simple: we treat your property, and your situation, with the same care we'd want for our own family.",
  ],
  credibilityPoints: [
    "13 years of real-estate sales experience",
    "Family background in real-estate brokerage and home building",
    "Construction fluency most cleanout companies lack",
    "On-site quoting for an accurate scope before work begins",
  ],
};
