...
export const warrenMi: CityDefinition = {
  slug: "warren-mi",
  cityName: "Warren",
  ...
  localAreas: [
    "Van Dyke Avenue",
    "Mound Road industrial corridor",
    "Groesbeck Highway",
  ...
  workContext:
    "The houses are small, so the volume is never on the main floor — it is in the basement, the detached garage and whatever has been stacked along the side of the yard. Much of this stock is still in original-owner hands, so estate clears and landlord turnovers on a short window both belong to the same street. Demolition here leans toward the single-car garage that has finally given up, the concrete under it, and tear-outs in houses bought to flip. Along Mound and Groesbeck there is shop and warehouse clearing too — racking, benches, pallets, leftover stock.",
  localConsiderations: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes — benches, racking, shelving, pallets, old inventory and general shop debris are standard commercial cleanout work. We can work around your operating hours if the space is still in use.",
    },
  ],
  metaDescription:
    "Property cleanouts and demolition in Warren, Michigan. Estate, rental and foreclosure clearing, packed basements, detached garage teardowns and shop clearing.",
  primaryKeyword: "property cleanout Warren MI",
  nearbySlugs: ["sterling-heights-mi", "detroit-mi", "clinton-township-mi", "royal-oak-mi"],
};
