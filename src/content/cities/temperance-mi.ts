...
export const temperanceMi: CityDefinition = {
  slug: "temperance-mi",
  cityName: "Temperance",
  countySlug: "monroe-county-mi",
  stateAbbr: "MI",
  localAreas: [
    "Bedford Township",
    "Lewis Avenue",
    "Sterns Road at US-23",
    "Secor Road",
    "Douglas Road",
    "Samaria Road",
  ],
  ...
  localConsiderations: [
    "Long gravel or unpaved drives soften after rain, so where the truck and trailer can sit gets planned around ground conditions rather than convenience",
    "On parcels still on well and septic, the drain field and the well head have to be located before anything heavier than a wheelbarrow tracks across the yard",
    "Along the Lewis Avenue frontage the lots run deep but the road shoulder is the only staging space, so loads go straight from the building onto the truck",
    "Quad-levels and split-levels put half-flights between every level, which makes carry distance rather than lot size the thing that sets the day",
    "Being on the Ohio line, many owners and heirs live on the Toledo side and want the scoping handled without a lot of trips",
  ],
  faqs: [
    {
      question: "We are on well and septic. Can your equipment reach the barn without wrecking the field?",
      answer:
  ...
  metaDescription:
    "Property cleanouts and demolition in Temperance, Michigan. Bedford Township estate clearing, garages, shops and outbuildings emptied or taken down entirely.",
  primaryKeyword: "property cleanout Temperance MI",
  nearbySlugs: ["monroe-mi", "saline-mi", "ypsilanti-mi", "ann-arbor-mi"],
};
