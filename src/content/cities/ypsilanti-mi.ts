...
export const ypsilantiMi: CityDefinition = {
  slug: "ypsilanti-mi",
  cityName: "Ypsilanti",
  ...
  localAreas: [
    ...
    "Normal Park and the Eastern Michigan campus edge",
  ...
  localConsiderations: [
    ...
    "Century-old frame houses here commonly have unfinished stone or rubble basements with low headroom and one narrow stair",
    "Foreclosure and bank-owned clearings frequently arrive with no utilities on, so lighting and hand-carry have to be planned in from the start",
    "Failing detached garages, back porches and sheds are a common teardown request on older lots, often at the same visit as the cleanout",
  ],
  faqs: [
    {
      question: "Can you clear a bank-owned or abandoned house in Ypsilanti?",
      answer:
        "Yes. Full property cleanouts cover foreclosure and REO work — furniture, appliances, household contents and debris out of the house, basement, garage and yard. Tell us at the walkthrough whether power and water are on so we bring the right kit.",
    },
    {
