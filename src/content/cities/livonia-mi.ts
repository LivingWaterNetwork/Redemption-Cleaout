  ...
  faqs: [
    {
      ...
      answer:
        "Yes, and it is usually where most of the day goes. A full property cleanout covers the basement, the crawl areas, the garage and the shed, not just the rooms upstairs. If the paneling and drop ceiling are coming out as well, that is demolition work and we can do both in the same visit.",
    },
    {
