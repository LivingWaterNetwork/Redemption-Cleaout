...
export const dearbornMi: CityDefinition = {
  slug: "dearborn-mi",
  cityName: "Dearborn",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes. Mark or set aside what is staying and we work around it. If you would rather do the sorting yourself first, we can schedule the clearing after — most families take that approach with paperwork, photographs and anything of sentimental value.",
    },
    {
