...
export const sterlingHeightsMi: CityDefinition = {
  slug: "sterling-heights-mi",
  cityName: "Sterling Heights",
  countySlug: "macomb-county-mi",
  stateAbbr: "MI",
  localAreas: [
    "the Hall Road (M-59) retail corridor",
    "Lakeside area",
    "Utica Road",
    "Metro Parkway and Schoenherr",
    "Van Dyke Avenue",
  ...
  faqs: [
    {
      ...
      answer:
        "One job. A full property cleanout covers the whole house — finished basement, garage, shed and yard included. If the paneling, carpet or built-ins are also coming out so the space can be redone, that part is demolition and we will price it together with the clearing.",
    },
    {
      question: "Can you take down a back-yard deck and haul everything away?",
      answer:
