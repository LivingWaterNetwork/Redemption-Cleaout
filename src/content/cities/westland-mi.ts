...
export const westlandMi: CityDefinition = {
  slug: "westland-mi",
  cityName: "Westland",
  ...
  localConsiderations: [
    ...
    "Apartment and townhouse clearouts mean stair carries, shared corridors and a dumpster area the complex controls, which we sort out with management before the day",
    "Driveways are narrow single-width strips; a loaded trailer usually parks on the street and the crew carries, which is worth knowing when you compare timing",
  ],
  faqs: [
    {
      question: "I manage rentals in Westland. Can you turn a unit around quickly between tenants?",
      answer:
        "Yes — tenant turnover clearing is routine for us. We take everything left behind, including appliances and garage or shed contents, and leave the unit empty and swept so your paint and flooring crews can start. Give us the access details and the date you need it by.",
    },
    {
      question: "My Westland house has no basement. Does that make a cleanout cheaper?",
      answer:
        "Sometimes, but not always. No basement means no stair carry, which helps, but it also means the storage has gone into the rooms, the attic and the shed instead. We price on what is actually there after the walkthrough, not on floor area.",
    },
    {
  ...
  metaDescription:
    "Cleanouts and demolition in Westland, Michigan — rental turnover and estate clearing, apartment and townhouse cleanouts, deck, shed and garage teardowns.",
  primaryKeyword: "property cleanout Westland MI",
  nearbySlugs: ["canton-mi", "livonia-mi", "redford-mi", "dearborn-mi"],
};
