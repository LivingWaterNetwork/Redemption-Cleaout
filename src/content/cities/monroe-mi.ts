...
export const monroeMi: CityDefinition = {
  slug: "monroe-mi",
  cityName: "Monroe",
  countySlug: "monroe-county-mi",
  stateAbbr: "MI",
  localAreas: [
    "Downtown and Loranger Square",
    "East Elm and North Macomb historic streets",
    "River Raisin waterfront",
    "South Monroe and the Telegraph Road corridor",
    "North Custer Road",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "It is a different service — demolition — but it is often scoped on the same visit. Detached garages, sheds and decks are routine teardowns, and we can quote the house clearing and the garage together in person after walking the property.",
    },
  ],
  metaDescription:
