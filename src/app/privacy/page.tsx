...
export default function PrivacyPage() {
  return (
    <>
      ...
      <PageHero eyebrow="Legal" title="Privacy Policy" variant="light" />
      <article className="container-page max-w-measure-lg space-y-6 py-section text-body-base text-steel-gray">
        ...
        <h2 className="mt-10 font-display text-xl font-semibold text-heritage-black">Information We Collect</h2>
        <p>
        ...
        <h2 className="mt-10 font-display text-xl font-semibold text-heritage-black">Analytics</h2>
        <p>
        ...
        <h2 className="mt-10 font-display text-xl font-semibold text-heritage-black">Third-Party Services</h2>
        <p>
        ...
        <h2 className="mt-10 font-display text-xl font-semibold text-heritage-black">Contact</h2>
        <p>
